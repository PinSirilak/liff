  ...
  <div class="app">
    ...
    <div class="broderB">
      <div class="row">
        <div class="col-12 lay_out_order_1">
          ...
          <p class="p_font">149/7 ม.6 ตำบลบ้านสวน</p>
          <p class="p_font">อำเภอเมือง จังหวัดชลบุรี</p>
          <p class="p_font">รหัสไปรษณ์ 20000 เบอร์โทรศัพท์ 0123456789</p>
        </div>
      </div>
    </div>
    ...
    <div class="container text-center">
      <div class="row row-cols-2">
        <div class="col-6 layout_btn">
          <div class='d-grid gap-5 col-12 mx-auto'>
            <a href='../index.php' type="button" class="btn add_btn  w_text_add">
              <img src="../image/next.png" alt=""> &nbsp; กลับไปเลือกสินค้า</a>
          </div>
        </div>
        <div class="col-6 layout_btn">
          <div class='d-grid gap-5 col-12 mx-auto'>
            <a href='../cart/pay_summary.php' class='btn abtn mt-20' type='submit'>
              <p class='wText'>ยืนยันคำสั่งซื้อ</p>
            </a>
          </div>
        </div>
      </div>
